...
class HumiditySensorResource(Resource):
    payload = ""
    sensehat = None

    def __init__(self, name="HumiditySensorResource", coap_server=None):
        '''
        Constructor
        '''
        super(HumiditySensorResource, self).__init__(name, coap_server, visible=True, observable=True, allow_children=True)
    ...
    def render_GET_advanced(self, request, response):
        ...
        '''
        try:
            self.payload = str(self.sensehat.get_humidity())
